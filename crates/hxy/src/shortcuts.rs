...
pub const COPY_HEX: KeyboardShortcut =
...
pub const PASTE_AS_HEX: KeyboardShortcut =
...
pub const SAVE_FILE_AS: KeyboardShortcut =
...
/// Reverse of [`NEXT_TAB`].
pub const PREV_TAB: KeyboardShortcut =
...
pub const FIND_GLOBAL: KeyboardShortcut =
