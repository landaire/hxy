...
menu-file-reopen-closed = Reopen Closed Tab
menu-file-quit = Quit
menu-edit = Edit
menu-edit-undo = Undo
menu-edit-redo = Redo
...
palette-save-as-download = Save as download...
palette-undo = Undo
palette-redo = Redo
plugins-wasm-unavailable = The plugin manager isn't available in the browser build -- WASM runtime + filesystem access are desktop-only. Built-in handlers like the ZIP VFS still work.
...
settings-template-value-format-collapsed-label = Per-type formats
...
settings-numeric-format-large-label = At/above
settings-numeric-format-threshold-label = Threshold
...
palette-hint-go-to-address = Virtual address (decimal, 0x..., +N, -N)
...
palette-go-to-address-entry = Go to address...
palette-go-to-address-shortcut-hint = type a virtual address (e.g. 0x80100000); resolved against the file's accepted base
palette-go-to-address-fmt = Go to address { $address }
palette-go-to-address-subtitle = file offset { $offset }
...
palette-copy-caret-address = Copy caret as address
palette-copy-selection-range = Copy selection range
palette-copy-selection-range-address = Copy selection range as address
palette-copy-selection-length = Copy selection length
palette-copy-file-length = Copy file length
palette-reopen-closed-tab = Reopen closed tab
vfs-loading-fmt = Loading { $name }...
vfs-failed-fmt = Could not load { $name }
...
palette-run-template-at-selection-entry = Run Template at Selection...
palette-run-template-at-selection-subtitle = Bind a template to [{ $start }..{ $end }]
...
# Tool-pane visibility (palette)
palette-tool-show-console = Show Console
palette-tool-close-console = Close Console
palette-tool-show-inspector = Show Inspector
palette-tool-close-inspector = Close Inspector
palette-tool-show-plugins = Show Plugins
palette-tool-close-plugins = Close Plugins
palette-tool-show-settings = Show Settings
palette-tool-close-settings = Close Settings
palette-tool-show-entropy = Show Entropy panel
palette-tool-close-entropy = Close Entropy panel
palette-tool-show-visualizer = Show Visualizer panel
palette-tool-close-visualizer = Close Visualizer panel
...
memory-panel-disclaimer = Tracked-cache bytes -- not exact allocator pages. Plugin VFS reads share their parent file's hex-view attribution.
